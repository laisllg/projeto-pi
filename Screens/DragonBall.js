...
const DragonBall = ({ navigation }) => {
  ...
  useEffect(() => {
    setComments(getComments("dragonball"));
  }, []);
    ...
    <View style={styles.container}>
      <View>
        <Appbar.Header theme={{ colors: { primary: "black" } }}>
          ...
          />
          <Appbar.Content title="Dragon Ball" titleStyle={styles.appbarTitle} />
          <TouchableOpacity
            onPress={() => {
              logoutUser();
      ...
      >
        ...
        <View style={{ alignItems: "center", justifyContent: "center" }}>
          <Text style={{ padding: 30, fontSize: 24 }}>
            Apesar da Terra estar em um período de calmaria, Goku se recusa a
            parar de treinar constantemente. O que ele não imaginava era que seu
            novo inimigo seria Broly, um poderoso super saiyajin sedento por
            vingança, que deseja destruir todos que encontrar pela frente.
          </Text>
          <View
            style={{
              alignItems: "center",
          ...
          >
            <View style={{ marginLeft: 15, marginRight: 15 }}>
              <TouchableOpacity
                onPress={() =>
                  navigation.navigate("VideoDragonBall", {
                    videoId: "AsCzBPla_Vg",
                  })
                }
              >
