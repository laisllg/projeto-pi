...
const OnePiece = ({ navigation }) => {
  ...
  useEffect(() => {
    setComments(getComments("onepiece"));
  }, []);
      ...
      >
        ...
        <View style={{ alignItems: "center", justifyContent: "center" }}>
          <Text style={{ padding: 30, fontSize: 24 }}>
            A trama segue Luffy, um jovem com o corpo elástico que sonha em
            criar sua própria tripulação e partir em uma aventura para se tornar
          ...
          >
            <View style={{ marginLeft: 15, marginRight: 15 }}>
              <TouchableOpacity
                onPress={() =>
                  navigation.navigate("VideoOnePiece", {
                    videoId: "Uj-K3cIIabA",
                  })
                }
              >
